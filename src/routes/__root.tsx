...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "A CISCE-affiliated senior secondary school in Ferozepur, Punjab. Since 2002, Disha Public School has cultivated academic excellence, character and global citizenship." },
